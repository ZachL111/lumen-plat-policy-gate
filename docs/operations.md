...
`lumen-plat-policy-gate` is centered on platform engineering work in Java. The technical target is: Package a Java local lab for policy analysis with seeded input scenarios, deterministic summary checks, and documented operating limits.
