...
lumen-plat-policy-gate is a Java project for platform engineering. It focuses on this technical goal: Package a Java local lab for policy analysis with seeded input scenarios, deterministic summary checks, and documented operating limits.
