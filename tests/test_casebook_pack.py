"""Regression checks for the lumen-plat-policy-gate casebook."""
...
from casebook.harness import assert_expected, lumen_plat_policy_gate_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(lumen_plat_policy_gate_summary(), assert_expected())
