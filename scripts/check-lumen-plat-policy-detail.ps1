...
$repo = "lumen-plat-policy-gate"
$language = "Java"
$category = "Platform engineering"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/lumen-plat-policy-walkthrough.md")) {
